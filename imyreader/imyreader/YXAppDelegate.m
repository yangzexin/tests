...
//  imyreader
//
//  Created by yangzexin on 7/1/13.
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    YXApp *app = [[YXApp alloc] initWithScriptBundle:[YXApplicationScriptBundle new]];
    app.relatedViewController = self.window.rootViewController;
